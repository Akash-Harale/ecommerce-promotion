      ...
      reviews: [
        {
          ...
          content: "Scaled from 100 to 10,000 products effortlessly. The analytics help us make data-driven decisions.",
          rating: 5,
        },
        {
          name: "Carlos Martinez",
          business: "Electronics Store",
          content: "Multi-channel selling increased our reach significantly. Now selling on 5 different platforms.",
          rating: 5,
        },
      ],
    },
      ...
      reviews: [
        {
          ...
          content: "The enterprise features and dedicated support team make managing our complex operations simple.",
          rating: 5,
        },
        {
          name: "Thomas Anderson",
          business: "Manufacturing Company",
          content: "Custom integrations with our ERP system work flawlessly. Couldn't be happier with the solution.",
          rating: 5,
        },
      ],
    },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <Badge className="mb-4 bg-blue-100 text-blue-800 hover:bg-blue-100">⭐ 4.9/5 Average Rating</Badge>
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            See what our customers have to say about their success with CommerceMax. Real stories, real results.
          </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Hear from businesses that transformed their operations</p>
          </div>
              ...
              <CardContent className="p-0">
                ...
                <div className="flex items-center justify-center mb-6">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-gray-600 text-lg">{testimonials[currentTestimonial].role}</div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Reviews by Business Size</h2>
            <p className="text-xl text-gray-600">Success stories from businesses of all sizes</p>
          </div>
                  ...
                  {category.reviews.map((review, reviewIndex) => (
                    <Card key={reviewIndex} className="p-6 bg-white">
                      <CardContent className="p-0">
                        ...
                        <blockquote className="text-gray-700 mb-4">"{review.content}"</blockquote>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12">Join thousands of successful businesses</p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Start your free trial today and see why 50,000+ businesses trust CommerceMax
          </p>
