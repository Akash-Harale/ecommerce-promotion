  ...
  const testimonials = [
    {
      ...
      content:
        "This platform transformed our online business. Sales increased by 300% in just 3 months!",
    ...
    },
    {
      ...
      content:
        "The analytics and inventory management features are game-changing. Highly recommend!",
      avatar: "/placeholder.svg?height=60&width=60",
      rating: 5,
    },
    {
      ...
      content:
        "Easy to set up, beautiful designs, and excellent customer support. Perfect for small businesses!",
      avatar: "/placeholder.svg?height=60&width=60",
      rating: 5,
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "AI-powered inventory management that predicts demand and automates restocking",
    },
    {
      icon: <TrendingUp className="h-8 w-8 text-primary" />,
      title: "Advanced Analytics",
      description:
        "Real-time insights and detailed reports to optimize your business performance",
    },
    {
      icon: <Shield className="h-8 w-8 text-primary" />,
      title: "Secure Payments",
      description:
        "Bank-level security with support for 50+ payment methods worldwide",
    },
    {
    ...
    },
    {
      ...
      title: "Global Reach",
      description:
        "Multi-currency, multi-language support to sell anywhere in the world",
    },
    {
      icon: <Users className="h-8 w-8 text-primary" />,
      title: "Customer Management",
      description:
        "Advanced CRM tools to build lasting relationships with your customers",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Powerful features designed to help you build, manage, and scale
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400 hover:text-white transition-colors">
                301/302, 3rd Floor, Saket Callipolis, Sarjapur - Marathalli
                Road, Doddakannelli, Bengaluru, Karnataka- 560035
              </p>
              <div className="mt-6">
